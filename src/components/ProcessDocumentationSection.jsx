        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-yellow-100/80 dark:bg-yellow-900/30 backdrop-blur-sm border border-yellow-200/50 dark:border-yellow-700/50 rounded-full px-4 py-2">
              <Workflow className="w-4 h-4 text-yellow-600 dark:text-yellow-400" />
              <span className="text-yellow-700 dark:text-yellow-300 font-medium text-sm">Process Documentation</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              <span className="text-gray-900 dark:text-white">Document and optimize processes</span>
              <br />
            ...
            <p className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Capture, standardize, and improve your business processes. ACROZ.AI makes it easy to create clear process documentation, ensure compliance, and drive continuous improvement across your organization.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  { icon: Workflow, text: 'Process mapping & flowcharts' },
                  { icon: FileText, text: 'Step-by-step documentation' },
                  { icon: CheckCircle, text: 'Standardization & compliance' },
                  { icon: Star, text: 'Continuous improvement tracking' },
                  { icon: BarChart3, text: 'Process analytics & reporting' }
                ].map((feature, index) => (
                  <motion.div
                    key={feature.text}
                    initial={{ opacity: 0, x: -20 }}
...
export default ProcessDocumentaion;