    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50/30 to-purple-50/30 dark:from-blue-900/10 dark:via-indigo-900/10 dark:to-purple-900/10">
      ...
      <section className="relative pt-24 pb-16 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-pink-100/80 dark:bg-pink-900/30 backdrop-blur-sm border border-pink-200/50 dark:border-pink-700/50 rounded-full px-4 py-2">
              <Play className="w-4 h-4 text-pink-600 dark:text-pink-400" />
              <span className="text-pink-700 dark:text-pink-300 font-medium text-sm">Interactive Learning</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              <span className="text-gray-900 dark:text-white">Learn by doing</span>
              <br />
              <span className="bg-gradient-to-r from-pink-500 via-yellow-500 to-purple-500 bg-clip-text text-transparent">
                with interactive tutorials
              </span>
            </h1>

            <p className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Experience hands-on learning with real-time feedback, collaborative exercises, and guided tutorials. ACROZ.AI makes mastering diagramming fun and effective.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  { icon: Play, text: 'Step-by-step interactive tutorials' },
                  { icon: Users, text: 'Collaborative learning sessions' },
                  { icon: MessageCircle, text: 'Real-time feedback & Q&A' },
                  { icon: Star, text: 'Gamified achievements' },
