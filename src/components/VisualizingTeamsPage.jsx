        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-blue-100/80 dark:bg-blue-900/30 backdrop-blur-sm border border-blue-200/50 dark:border-blue-700/50 rounded-full px-4 py-2">
              ...
              <span className="text-blue-700 dark:text-blue-300 font-medium text-sm">Team Visualization</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              <span className="text-gray-900 dark:text-white">Visualizing teams</span>
              <br />
            ...
            <p className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Transform how your organization operates with powerful team visualization tools. Create dynamic org charts, optimize team structures, and gain organizational clarity.
            </p>
...
export default VisualizingTeamsPage;