...
const VisualizingInfrastructure = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-green-100/80 dark:bg-green-900/30 backdrop-blur-sm border border-green-200/50 dark:border-green-700/50 rounded-full px-4 py-2">
              ...
              <span className="text-green-700 dark:text-green-300 font-medium text-sm">Infrastructure Visualization</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              <span className="text-gray-900 dark:text-white">Visualize your infrastructure</span>
              <br />
            ...
            <p className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Map out IT, cloud, and network infrastructure. ACROZ.AI helps IT teams document, optimize, and secure their systems with intuitive, interactive diagrams.
            </p>
...
export default VisualizingInfrastructure;