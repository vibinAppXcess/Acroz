    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50/30 to-purple-50/30 dark:from-blue-900/10 dark:via-indigo-900/10 dark:to-purple-900/10">
      ...
      <section className="relative pt-24 pb-16 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-gray-100/80 dark:bg-gray-900/30 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-full px-4 py-2">
              <Workflow className="w-4 h-4 text-gray-600 dark:text-gray-400" />
              <span className="text-gray-700 dark:text-gray-300 font-medium text-sm">More Use Cases</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              <span className="text-gray-900 dark:text-white">Endless diagramming possibilities</span>
              <br />
              <span className="bg-gradient-to-r from-gray-600 via-blue-500 to-purple-500 bg-clip-text text-transparent">
                for every team
              </span>
            </h1>

            <p className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              ACROZ.AI supports a wide range of diagram types and use cases. Explore process mapping, mind maps, org charts, customer journeys, and more—all in one platform.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  { icon: Target, text: 'Scrum team optimization' },
                  { icon: Workflow, text: 'Visual Activities for alignment' },
                  { icon: Zap, text: 'Sprint preparation tools' }
                ].map((feature, index) => (
                  <motion.div
                    key={feature.text}
                    initial={{ opacity: 0, x: -20 }}
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50/50 to-blue-50/50 dark:from-gray-800/50 dark:to-blue-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Explore a variety of diagram types and use cases
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {[
              { icon: Workflow, title: 'Process Mapping', desc: 'Visualize and optimize business processes.' },
              { icon: Brain, title: 'Mind Mapping', desc: 'Capture ideas and brainstorm visually.' },
              { icon: Users, title: 'Org Charts', desc: 'Map out team structures and reporting lines.' },
              { icon: Globe, title: 'Customer Journeys', desc: 'Understand and improve user experiences.' },
              { icon: Star, title: 'Project Planning', desc: 'Plan, track, and deliver projects.' },
              { icon: BarChart3, title: 'Data Visualization', desc: 'Turn data into actionable insights.' }
            ].map((useCase, index) => (
              <motion.div
                key={useCase.title}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1 }}
                className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 flex flex-col items-center text-center space-y-3 border border-gray-100 dark:border-gray-700"
              >
                <div className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 mb-2">
                  <useCase.icon className="w-7 h-7 text-blue-600 dark:text-purple-400" />
                </div>
                <div className="font-semibold text-lg text-gray-900 dark:text-white">{useCase.title}</div>
                <div className="text-gray-600 dark:text-gray-300 text-sm">{useCase.desc}</div>
              </motion.div>
            ))}
          </div>
        </div>
