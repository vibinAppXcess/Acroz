        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-indigo-100/80 dark:bg-indigo-900/30 backdrop-blur-sm border border-indigo-200/50 dark:border-indigo-700/50 rounded-full px-4 py-2">
              ...
              <span className="text-indigo-700 dark:text-indigo-300 font-medium text-sm">Visio Replacement</span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              <span className="text-gray-900 dark:text-white">A modern Visio alternative</span>
              <br />
            ...
            <p className="max-w-3xl mx-auto text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Effortlessly import, edit, and export Visio files. ACROZ.AI offers full compatibility, advanced features, and a user-friendly interface for teams moving beyond legacy tools.
            </p>
...
export default VisioReplacement;